...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const defaultAdminProfile = {
        name: "Iradina Rodriguez",
        email: "iradina@ecologica.com",
        avatar: "img/avatar/avatar-adm.png",
        memberSince: "22/09/2025" // <--- DATA DEFINIDA AQUI
    };
    ...
    let simulatedCampaigns = storedCampaigns ? JSON.parse(storedCampaigns) : [
        ...
        { id: 1, title: "Recicla Pomerode", startDate: "2025-11-17", endDate: "2025-12-22", description: "Preservando nossa tradição, cuidando do futuro. Localize o ecoponto mais próximo, registre seus descartes e ajude a manter nossa cidade exemplo.", image: "https://i.postimg.cc/GtD9zT15/Gemini-Generated-Image-a1hjlua1hjlua1hj.png", points: 200 },
        { id: 2, title: "Plástico Zero", startDate: "2025-11-01", endDate: "2025-12-12", description: "Bora limpar? O Mutirão Plástico Zero vai rolar de 01/11 a 12/12. Traga disposição, as luvas são por nossa conta! 📍 QG: Prefeitura de Blumenau | ⏰ Saída: Diariamente às 16hs", image: "https://i.postimg.cc/05CN5vyK/Gemini-Generated-Image-rk852irk852irk85.png", points: null },
        { id: 3, title: "Descarte Digital", startDate: "2025-10-25", endDate: "2025-12-22", description: "Liberte suas gavetas! Tem cabos, pilhas ou celulares velhos parados? De 25/10 a 22/12, traga seus eletrônicos para o descarte ambientalmente seguro. 📍 Coleta: Senac Blumenau | ⏰ Horário: Das 8hs às 20hs", image: "https://i.postimg.cc/s2CmJ5dn/Gemini-Generated-Image-d4buo2d4buo2d4bu.png", points: 500 },
    ];
    ...
    const DEFAULT_SETTINGS = {
        ...
        settingContactPhone: "(47) 1234-5678" // <-- Verifique se este já foi adicionado
    };
    ...
    const loadCompanies = () => {
        ...
        simulatedSupporters = storedSupporters ? JSON.parse(storedSupporters) : [
            // Exemplos iniciais se localStorage vazio
            { id: 2001, name: "Supermercado Econômico", email: "mkt@economico.com", type: "apoiadora", cnpj: "74.488.455/0001-56", address: "Rua Principal, 100, Encano, Indaial-SC" },
            { id: 2002, name: "Loja VerdesFolhas", email: "contato@verdesfolhas.com", type: "apoiadora", cnpj: "44.444.444/0001-44", address: "Rua das Vitrines, 20, Centro, Blumenau-SC" }
        ];
